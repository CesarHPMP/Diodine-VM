...
| 2 | W2 — adversarial suite exists, every check demonstrated failing | **done** — 68 cases across framing, ingest and exhaustion; controls and driven failures throughout. Found `ING-003`, `OUT-004`, corrected `RES-003` |
