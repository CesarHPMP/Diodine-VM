...
| 2 | W2 — adversarial suite exists, every check demonstrated failing | **in progress** — framing and ingest corpora landed (61 cases, each demonstrated failing); exhaustion and in-VM cases open |
